...
public interface HabitTrackingRecordRepository extends JpaRepository<HabitTrackingRecord, String> {
    ...
    List<HabitTrackingRecord> findByHabitId(String habitId);
    ...
    List<HabitTrackingRecord> findByHabitIdAndCompletedAtBetween(String habitId, LocalDateTime start, LocalDateTime end);
    ...
    Optional<HabitTrackingRecord> findMostRecentByHabitId(String habitId);
